...
def get_args():
    ...
    parser.add_argument('--num_points', type=int, default=48, help='number of evaluation points by the ODE solver, including the initial point')
...
def train(args):
    ...
    # us = [0.0]
    data = get_dataset(seed=args.seed, timesteps=48,
